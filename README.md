...
[???? Русский](#-русский--russian) | [???? English](#-english)
...
<div align="center">
<img src="tg_ws_proxy_haos/icon.png" width="128" height="128" alt="TG WS Proxy Logo">
</div>
...
**TG WS Proxy** - это локальный MTProto прокси для Telegram, работающий как аддон в Home Assistant OS.  
Он позволяет обходить блокировки, защищать соединение и использовать Telegram даже в ограниченных сетях.
...
**TG WS Proxy** is a local MTProto proxy for Telegram running as a Home Assistant OS addon.  
It helps bypass blocking, secure your connection, and use Telegram even in restricted networks.
...
**? If you like this addon, star it on GitHub!**

[![GitHub](https://img.shields.io/badge/GitHub-chOng--m0rrino-181717?style=for-the-badge&logo=github)](https://github.com/chOng-m0rrino)
